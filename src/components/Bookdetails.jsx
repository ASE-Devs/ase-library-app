...
const book = {
    ...
    rating: 4,
    description: "A compelling narrative about finding hope and strength through life's unpredictable journey.",
...
const reviews = [
    {
        ...
        content: "Every chapter resonated deeply with me. The emotions felt real and raw.",
    },
    {
        id: 2,
        ...
        content: "The author's writing style is captivating. Loved every bit of it.",
    },
];
        ...
        <PagesLayout>
            <div className="container mx-auto px-4 py-10 max-w-5xl">
                ...
                <div className="text-sm text-gray-500 mb-4">
                    ...
                    <Link to="/book-details" className="hover:text-gray-700 cursor-pointer">Books</Link>
                    <span className="mx-2">/</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mb-12">
                    ...
                    <div>
                        <Link to={`/books/${book.id}`}>
                            <h1 className="text-3xl font-bold text-gray-800 mb-2 hover:underline">{book.title}</h1>
                        </Link>
                        <p className="text-lg text-gray-600 mb-4">
                            by <span className="italic">{book.author}</span>
                        </p>
                        <p className="text-xs uppercase text-gray-500 tracking-wide mb-3">{book.genre}</p>

                        {/* Rating */}
                        <div className="flex items-center mb-6">
                            <div className="mr-2 text-sm font-medium text-gray-600">Rating:</div>
                ...
                {/* Reviews Section */}
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">What Readers Say</h2>
                        ...
                        {reviews.map((review) => (
                            <div key={review.id} className="p-6 bg-white shadow-lg rounded-lg">
                                <div className="flex items-center mb-3">
                                    ...
                                    <div>
                                        <div className="font-medium text-gray-700">{review.user.name}</div>
                                        <div className="text-xs text-gray-400">{review.user.date}</div>
                                    </div>
                                </div>
